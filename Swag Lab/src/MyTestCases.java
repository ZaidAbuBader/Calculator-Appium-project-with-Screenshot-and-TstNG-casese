...
public class MyTestCases {
	...
	public void AddMyItems() throws InterruptedException {// throws InterruptedException from thread.sleep()
		...
		// can't type 6 ,because its maybe differ latterly
		...
		// here in Assertion is t certainty the function work correctly
...
//
	...
	public void TestTitle() {
		String ExpectrdTitle="Swag Labs";
		String ActualTitle=driver.getTitle();
		Assert.assertEquals(ActualTitle, ExpectrdTitle,"mar7aba test for title @@@@@@@@@@@@@");
		

	}
	@Test
	public void TestThetitle2() {
		String ExpectedTitle ="Swag Labs";
		String ActualTitle=driver.getTitle();
		String CurrentUrl= driver.getCurrentUrl();
		System.out.println(CurrentUrl);
		System.out.println(driver.getPageSource());
		Assert.assertEquals(ActualTitle, ExpectedTitle, "this is to check the title");
